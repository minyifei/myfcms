...
<html lang="en">
		...
		<script type="text/javascript">
			$(document).ready(function(){
            	...
            	$("#btnSubmit").click(function(){
            		...
            		$("#formCollect").attr("action","__APP__/index.php?m=Collect&a=update_handler").attr("target","");
            	})
			})
	...
	<body>
		<div class="main">
			<div class="top">
				<div class="position">
					您现在的位置：<a href="__APP__/index.php?m=Collect&a=main">采集节点管理</a><span class="split">&gt;</span>修改节点
				</div>
			</div>
				<form id="formCollect" action="__APP__/index.php?m=Collect&a=update_handler" method="post" target="result_frame">
			<div class="center">
				<ul class="tab">
								...
								<td class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
							          <tbody>
							            ...
							            <td width="408">
							            	<input name="name" type="text" id="txtName" value="<?php echo ($node["name"]); ?>" style="width:328px">
								...
								<td class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
							          <tbody>
							            ...
							            <td width="408">
							            	<input name="listurl" type="text" id="txtListurl" value="<?php echo ($node["listurl"]); ?>" style="width:328px">
								...
								<td class="bline">
						        	...
						        	<tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtListStart" name="liststart" style="width:328px"><?php echo ($node["liststart"]); ?></textarea>
							          </td>
							        ...
							        <tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtListEnd"  name="listend" style="width:328px"><?php echo ($node["listend"]); ?></textarea>
							          </td>
							        ...
							        <tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<input name="linkinc" type="text" id="txtLinkinc" value="<?php echo ($node["linkinc"]); ?>" style="width:328px">
							          </td>
							          <td width="262"></td>
							        </tr>
							        <tr>
							          <td width="140">&nbsp;必须包含：</td>
							          <td width="408" style="padding:5px 0;">
							          	<input name="linknot" type="text" id="txtLinknot" value="<?php echo ($node["linknot"]); ?>" style="width:328px">
							          </td>
							          <td width="262"></td>
							        </tr>
							      </tbody></table>
								...
								<td class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
							          <tbody>
							            ...
							            <td width="408">
							            	<input name="conurl" type="text" id="txtConurl" value="<?php echo ($node["conurl"]); ?>" style="width:328px">
							...
							<tr>
								<td class="bline">
						        	...
						        	<tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtTitleStart" name="title_start" style="width:328px"><?php echo ($node["titlestart"]); ?></textarea>
							          </td>
							           <td width="140" class="red">&nbsp;标题结束HTML：</td>
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtTitleEnd"  name="title_end" style="width:328px"><?php echo ($node["titleend"]); ?></textarea>
							          </td>
							        </tr>
							        <tr>
						        		<td colspan="4">
						        	...
						        	<tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txkeywordStart" name="keyword_start" style="width:328px"><?php echo ($node["keywordstart"]); ?></textarea>
							          </td>
							           <td width="140">&nbsp;关键字结束HTML：</td>
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtKeywordEnd"  name="keyword_end" style="width:328px"><?php echo ($node["keywordend"]); ?></textarea>
							          </td>
							        </tr>
							        <tr>
						        		<td colspan="4">
						        	...
						        	<tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtDescStart" name="desc_start" style="width:328px"><?php echo ($node["descstart"]); ?></textarea>
							          </td>
							           <td width="140">&nbsp;摘要结束HTML：</td>
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtDescEnd"  name="desc_end" style="width:328px"><?php echo ($node["descend"]); ?></textarea>
							          </td>
							        </tr>
							        <tr>
						        		<td colspan="4">
						        	...
						        	<tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtSourceStart" name="source_start" style="width:328px"><?php echo ($node["sourcestart"]); ?></textarea>
							          </td>
							           <td width="140">&nbsp;来源结束HTML：</td>
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtSourceEnd"  name="source_end" style="width:328px"><?php echo ($node["sourceend"]); ?></textarea>
							          </td>
							        </tr>
							        <tr>
						        		<td colspan="4">
						        	...
						        	<tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtTimeStart" name="time_start" style="width:328px"><?php echo ($node["timestart"]); ?></textarea>
							          </td>
							           <td width="140">&nbsp;时间结束HTML：</td>
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtTimeEnd"  name="time_end" style="width:328px"><?php echo ($node["timeend"]); ?></textarea>
							          </td>
							        </tr>
							        <tr>
						        		<td colspan="4" style="font-weight:bold">
						        	...
						        	<tr>
							          ...
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtContentStart" name="content_start" style="width:328px"><?php echo ($node["contstart"]); ?></textarea>
							          </td>
							           <td width="140" class="red">&nbsp;内容结束HTML：</td>
							          <td width="408" style="padding:5px 0;">
							          	<textarea id="txtContentEnd"  name="content_end" style="width:328px"><?php echo ($node["contend"]); ?></textarea>
							          </td>
							        </tr>
							        <tr>
						        		<td colspan="4" style="font-weight:bold">
							        ...
							        <tr>
							        	<td colspan="4">
							        		<input type="checkbox" name="filter[]" <?php if(!empty($div_l)): ?>checked="checked"<?php endif; ?> value="div_l" />&lt;div(.*)&gt;&nbsp;
							        		<input type="checkbox" name="filter[]" <?php if(!empty($div_r)): ?>checked="checked"<?php endif; ?>  value="div_r" />&lt;/div&gt;&nbsp;
							        		<input type="checkbox" name="filter[]" <?php if(!empty($a)): ?>checked="checked"<?php endif; ?>  value="a" />&lt;a(.*)&gt;(.*)&lt;a&gt;&nbsp;
							        		<input type="checkbox" name="filter[]" <?php if(!empty($js)): ?>checked="checked"<?php endif; ?>  value="js" />&lt;script(.*)&gt;(.*)&lt;script&gt;&nbsp;
							        		<input type="checkbox" name="filter[]" <?php if(!empty($iframe)): ?>checked="checked"<?php endif; ?>  value="iframe" />&lt;iframe(.*)&gt;(.*)&lt;iframe&gt;&nbsp;
							        		<input type="checkbox" name="filter[]" <?php if(!empty($style)): ?>checked="checked"<?php endif; ?>  value="style" />&lt;style(.*)&gt;(.*)&lt;style&gt;&nbsp;
							        	</td>
							        </tr>
							      </tbody></table>
								</td>
