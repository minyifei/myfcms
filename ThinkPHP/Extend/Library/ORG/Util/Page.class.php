...
class Page {
     ...
     * @param array $parameter  分页跳转的参数
     +----------------------------------------------------------
     */
    public function __construct($totalRows,$listRows='',$parameter='',$url='',$nowPage) {
    ...
    public function show() {
        ...
        if(C("MYFCMS_URLTYPE")!="html"){
	        ...
	        if($nowCoolPage == 1){
	            ...
	            $preRow =  (($nowCoolPage-1)*$this->rollPage);//$this->nowPage-$this->rollPage;
	        ...
	        if($nowCoolPage == $this->coolPages){
	            ...
	            $nextRow =  ($nowCoolPage*$this->rollPage)+1;//$this->nowPage+$this->rollPage;
        	...
        	if($nowCoolPage == 1){
        		...
        		$theFirst = "<a href='".$url."1.html' >".$this->config['first']."</a>";
        	}
        	if($nowCoolPage == $this->coolPages){
        		$nextPage = "";
        		$theEnd="";
