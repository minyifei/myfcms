...
class SimpleDom{
	...
	function str_get_html($str, $lowercase=false, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT)
	{
	    $dom = new simple_html_dom(null, $lowercase, $forceTagsClosed, $target_charset, $defaultBRText);
	    if (empty($str))
	    {
...
class simple_html_dom {
    ...
    function load($str, $lowercase=false, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT) {
        global $debugObject;
