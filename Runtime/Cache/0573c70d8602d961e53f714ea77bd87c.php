		...
		<div class="main">
			<div class="main-left">
				<div class="sidebar slidebar-top">
					<h2>排行榜</h2>
					<ul>
						 <?php $urltype="html"; $_result=D('Archives')->relation(true)->field('body',true)->where("1=1")->order("click desc")->limit("11")->select(); if ($_result): $i=0;foreach($_result as $key=>$vo):++$i;$mod = ($i % 2 ); $arctype=$vo[Arctype];$arcpic=$vo[litpic];$typedir=$vo[Arctype][typedir];if($urltype=="static"):$vo["arcurl"]="__APP__/$typedir/$arctype[methodname]-$vo[id].html";$vo["typeurl"]="__APP__/$arctype[classname]/$typedir-$arctype[methodname].html";elseif($urltype=="html"):$vo["arcurl"]="__APP__/archives/$arcfix$vo[id].html";$vo["typeurl"]="__APP__/category/$arctype[typedir]/$arcfix";else:$vo["typeurl"]="__APP__/index.php?m=$arctype[classname]&a=$arctype[methodname]&id=$vo[typeid]";$vo["arcurl"]="__APP__/index.php?m=Archives&a=$arctype[methodname]&id=$vo[id]";endif;if(!empty($arcpic)):$vo["litpic"]="__APP__/admin/Uploads/Arctives/$vo[litpic]";endif; ?><li>
			                 <a href="<?php echo ($vo["arcurl"]); ?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a> 
			                </li><?php endforeach; endif;?>
					</ul>
				</div>
				<div class="sidebar slidebar-rand new-box-h">
					<h2>热评文章</h2>
					<ul>
						 <?php $urltype="html"; $_result=D('Archives')->relation(true)->field('body',true)->where("1=1")->order("id desc")->limit("10")->select(); if ($_result): $i=0;foreach($_result as $key=>$vo):++$i;$mod = ($i % 2 ); $arctype=$vo[Arctype];$arcpic=$vo[litpic];$typedir=$vo[Arctype][typedir];if($urltype=="static"):$vo["arcurl"]="__APP__/$typedir/$arctype[methodname]-$vo[id].html";$vo["typeurl"]="__APP__/$arctype[classname]/$typedir-$arctype[methodname].html";elseif($urltype=="html"):$vo["arcurl"]="__APP__/archives/$arcfix$vo[id].html";$vo["typeurl"]="__APP__/category/$arctype[typedir]/$arcfix";else:$vo["typeurl"]="__APP__/index.php?m=$arctype[classname]&a=$arctype[methodname]&id=$vo[typeid]";$vo["arcurl"]="__APP__/index.php?m=Archives&a=$arctype[methodname]&id=$vo[id]";endif;if(!empty($arcpic)):$vo["litpic"]="__APP__/admin/Uploads/Arctives/$vo[litpic]";endif; ?><li>
			...
			<div class="main-right">
				<div class="news">
					<div class="news-title">
						<h2>最近更新</h2>
						<p>
							<a href="http://www.minyifei.cn/" target="_blank">感谢使用MyfCMS系统</a>
						</p>
						<div class="clear"></div>
					</div>
					<div class="news-list">
						<ul>
						    <?php $urltype="html"; $_result=D('Archives')->relation(true)->field('body',true)->where("1=1")->order("id desc")->limit("22")->select(); if ($_result): $i=0;foreach($_result as $key=>$vo):++$i;$mod = ($i % 2 ); $arctype=$vo[Arctype];$arcpic=$vo[litpic];$typedir=$vo[Arctype][typedir];if($urltype=="static"):$vo["arcurl"]="__APP__/$typedir/$arctype[methodname]-$vo[id].html";$vo["typeurl"]="__APP__/$arctype[classname]/$typedir-$arctype[methodname].html";elseif($urltype=="html"):$vo["arcurl"]="__APP__/archives/$arcfix$vo[id].html";$vo["typeurl"]="__APP__/category/$arctype[typedir]/$arcfix";else:$vo["typeurl"]="__APP__/index.php?m=$arctype[classname]&a=$arctype[methodname]&id=$vo[typeid]";$vo["arcurl"]="__APP__/index.php?m=Archives&a=$arctype[methodname]&id=$vo[id]";endif;if(!empty($arcpic)):$vo["litpic"]="__APP__/admin/Uploads/Arctives/$vo[litpic]";endif; ?><li>
				                 <a href="<?php echo ($vo["arcurl"]); ?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo (myfsubstr($vo["title"],0,20)); ?></a><?php echo (date("m-d",strtotime($vo["sendtime"]))); ?> 
				                </li><?php endforeach; endif;?>
						</ul>
						<div class="clear"></div>
					</div>
				...
				<?php $urltype="html"; $_result=M('arctype')->field('body',true)->where("1=1  and topid=0 and typepro in(0,1)")->order("sortrank asc")->select(); if ($_result): $ck=0;foreach($_result as $key=>$toptype):++$ck;$mod = ($ck % 2 );$typepro=$toptype[typepro];if($urltype=="static"):$toptype["typeurl"]="__APP__/$toptype[classname]/$toptype[typedir]-$toptype[methodname].html";elseif($urltype=="html"):$toptype["typeurl"]="__APP__/category/$toptype[typedir]/$arcfix";else:$toptype["typeurl"]="__APP__/index.php?m=$toptype[classname]&a=$toptype[methodname]&id=$toptype[id]";endif;if($typepro==2):$toptype["typeurl"]="$toptype[typedir]";endif;?><div class="new-box <?php if(($mod) == "0"): ?>new-box-r<?php endif; ?>">
						<div class="news-title">
							<h2><?php echo ($toptype["typename"]); ?></h2>
							<p>
								<a href="<?php echo ($toptype["typeurl"]); ?>" target="_blank">MORE&gt;</a>
							</p>
							<div class="clear"></div>
						</div>
						<div class="box-list">
							<div class="imgtxt">
								<?php  $m_arctype = M("arctype");$child = $m_arctype->where("topid=$toptype[id]")->select();$typeids=$toptype[id];if($child):foreach ($child as $kk => $v):$typeids .=",".$v[id];endforeach;endif;$urltype="html"; $_result=D('Archives')->relation(true)->field('body',true)->where("1=1 and typeid in($typeids) and POSITION('c' in flag)")->order("id desc")->limit("1")->select(); if ($_result): $i=0;foreach($_result as $key=>$vo):++$i;$mod = ($i % 2 ); $arctype=$vo[Arctype];$arcpic=$vo[litpic];$typedir=$vo[Arctype][typedir];if($urltype=="static"):$vo["arcurl"]="__APP__/$typedir/$arctype[methodname]-$vo[id].html";$vo["typeurl"]="__APP__/$arctype[classname]/$typedir-$arctype[methodname].html";elseif($urltype=="html"):$vo["arcurl"]="__APP__/archives/$arcfix$vo[id].html";$vo["typeurl"]="__APP__/category/$arctype[typedir]/$arcfix";else:$vo["typeurl"]="__APP__/index.php?m=$arctype[classname]&a=$arctype[methodname]&id=$vo[typeid]";$vo["arcurl"]="__APP__/index.php?m=Archives&a=$arctype[methodname]&id=$vo[id]";endif;if(!empty($arcpic)):$vo["litpic"]="__APP__/admin/Uploads/Arctives/$vo[litpic]";endif; ?><a href="<?php echo ($vo["arcurl"]); ?>" title="<?php echo ($vo["title"]); ?>" target="_blank">
									<img src="<?php echo (($vo["litpic"])?($vo["litpic"]):"__MYFCMSPUBLIC__/images/nopic.jpg"); ?>" border="0" width="120" height="90" alt="<?php echo ($vo["title"]); ?>"></a>
								<h3><a href="<?php echo ($vo["arcurl"]); ?>" title="<?php echo ($vo["title"]); ?>"><?php echo (myfsubstr($vo["title"],0,13)); ?></a></h3>
								<p><?php echo (myfsubstr($vo["description"],0,40)); ?><a href="<?php echo ($vo["arcurl"]); ?>">&gt;&gt;详细</a></p><?php endforeach; endif;?>
							</div>
							<ul>
								<?php  $m_arctype = M("arctype");$child = $m_arctype->where("topid=$toptype[id]")->select();$typeids=$toptype[id];if($child):foreach ($child as $kk => $v):$typeids .=",".$v[id];endforeach;endif;$urltype="html"; $_result=D('Archives')->relation(true)->field('body',true)->where("1=1 and typeid in($typeids)")->order("id desc")->limit("6")->select(); if ($_result): $i=0;foreach($_result as $key=>$vo):++$i;$mod = ($i % 2 ); $arctype=$vo[Arctype];$arcpic=$vo[litpic];$typedir=$vo[Arctype][typedir];if($urltype=="static"):$vo["arcurl"]="__APP__/$typedir/$arctype[methodname]-$vo[id].html";$vo["typeurl"]="__APP__/$arctype[classname]/$typedir-$arctype[methodname].html";elseif($urltype=="html"):$vo["arcurl"]="__APP__/archives/$arcfix$vo[id].html";$vo["typeurl"]="__APP__/category/$arctype[typedir]/$arcfix";else:$vo["typeurl"]="__APP__/index.php?m=$arctype[classname]&a=$arctype[methodname]&id=$vo[typeid]";$vo["arcurl"]="__APP__/index.php?m=Archives&a=$arctype[methodname]&id=$vo[id]";endif;if(!empty($arcpic)):$vo["litpic"]="__APP__/admin/Uploads/Arctives/$vo[litpic]";endif; ?><li>
					                 <a href="<?php echo ($vo["arcurl"]); ?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a> 
					                </li><?php endforeach; endif;?>
							</ul>
						</div>
			...
			<div class="links">
				...
				<div class="links-body">
					<ul>
						<?php $_result=M('flink')->select(); if ($_result): $k=0;foreach($_result as $key=>$vo):++$k;$mod = ($k % 2 );$vo["linkurl"]="$vo[url]";?><li>
					             <a href="<?php echo ($vo["linkurl"]); ?>" target="_blank"><?php echo ($vo["webname"]); ?></a>
					        </li><?php endforeach; endif;?>
					</ul>
				</div>
			</div>
